...
void DefaultStorageStage::handle_event(StageEvent *event) {
  ...
  case SCF_DELETE: {
    ...
    //   printf("left_is_attr: %d\n", deletes.conditions[0].left_is_attr);
    //   printf("left_attr: %s\n", deletes.conditions[0].left_attr.attribute_name);
    //   printf("right_is_attr: %d\n", deletes.conditions[0].right_is_attr);
    //   printf("right_value_data: %d\n", *(int*)deletes.conditions[0].right_value.data);

    //   printf("left_is_attr: %d\n", deletes.conditions[1].left_is_attr);
    //   printf("left_attr: %s\n", deletes.conditions[1].left_attr.attribute_name);
    //   printf("right_is_attr: %d\n", deletes.conditions[1].right_is_attr);
    //   printf("right_value_data: %d\n", *(int*)deletes.conditions[1].right_value.data);
