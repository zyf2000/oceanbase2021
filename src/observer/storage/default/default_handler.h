...
RC create_multi_index(Trx *trx, 
  ...
  RC insert_record_tuples(Trx *trx, const char *dbname, const char *relation_name, int insert_tuple_num, const InsertTuple *insert_tuples);
