...
typedef struct {
  ...
  size_t insert_tuple_num;              // Number of insert tuples
  InsertTuple insert_tuples[MAX_NUM];   // Tuples of insert
//   size_t value_num;       // Length of values
//   Value values[MAX_NUM];  // values to insert
} Inserts;
...
typedef struct {
  ...
  int nullable;     // whether this attr is nullable
} AttrInfo;
